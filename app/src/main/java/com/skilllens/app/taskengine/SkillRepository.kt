...
object SkillRepository {
    ...
    /**
     * Returns all available skill definitions.
     * In the MVP this is a hard-coded list.
     * Future: Load from JSON assets or a database.
     */
    ...
    private fun electricalWiringSkill() = SkillDefinition(
        ...
        steps = listOf(
            TaskStep(
                ...
                requiredObjects      = listOf("terminal_block", "board"),
                requiredRelationships = emptyList(),
                successState = TaskState.STEP_2_PICK_WIRE.name,
                errorStates  = listOf("wrong_component"),
                timeoutMs    = 20_000L,
                minConfidence = 0.60f,
                debounceFrames = 4,
            ),
            TaskStep(
                ...
                requiredObjects       = listOf("red_wire", "hand"),
            ...
            TaskStep(
                ...
                errorStates   = listOf("wrong_connection", "wrong_component"),
                timeoutMs     = 30_000L,
                minConfidence = 0.70f,
                debounceFrames = 6,
            ),
            ...
            TaskStep(
                ...
                errorStates   = listOf("wrong_connection"),
                timeoutMs     = 20_000L,
                minConfidence = 0.75f,
                debounceFrames = 10,
            ),
